...
De methodologie die voor het project zal gebruikt worden is agile. Er zullen constant nieuwe updates uitgevoerd worden om elke module om de luchtkwaliteitssensor efficiënter en beter te maken. 
...
De batterij levert een voltage van 7.4V aan. Deze is natuurlijk te hoog voor de gebruikte componenten waardoor er 2 lineaire serie regelaars nodig zijn om het voltage te verlagen. Het verlaagt de 7.4V naar zowel 5V als 3.3V. Vervolgens worden de verschillende voltages naar de juiste modules uitgestuurd.
